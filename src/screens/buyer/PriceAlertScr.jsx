...
function PriceAlertScr({onBack}){
  ...
  return(<div className="scr" style={{padding:16,paddingBottom:20}}>
    <div className="appbar" style={{padding:0,marginBottom:10}}><button onClick={onBack}>←</button><h2><Icon name="bell" size={16}/>{" "}Alertes de prix</h2><div style={{width:38}}/></div>
    ...
    {alertsList.length===0&&<div style={{textAlign:"center",padding:"40px 0"}}><div style={{fontSize:36}}><Icon name="bell" size={18}/></div><div style={{fontSize:13,color:"var(--muted)",marginTop:6}}>Aucune alerte de prix</div><div style={{fontSize:11,color:"var(--sub)",marginTop:4}}>Ajoutez une alerte depuis la fiche produit</div></div>}
  </div>);
}
