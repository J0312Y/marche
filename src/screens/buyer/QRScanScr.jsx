...
function QRScanScr({onBack,go}){
  ...
  return(<div className="scr" style={{display:"flex",flexDirection:"column",height:"100%"}}>
    ...
    <div style={{flex:1,display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",padding:20,textAlign:"center"}}>
      {!scanned?<>
        <div onClick={mockScan} style={{width:200,height:200,borderRadius:24,border:"3px solid #F97316",position:"relative",cursor:"pointer",display:"flex",alignItems:"center",justifyContent:"center",background:"var(--card)"}}>
          <div style={{position:"absolute",top:-2,left:-2,width:40,height:40,borderTop:"4px solid #F97316",borderLeft:"4px solid #F97316",borderRadius:"12px 0 0 0"}}/>
          <div style={{position:"absolute",top:-2,right:-2,width:40,height:40,borderTop:"4px solid #F97316",borderRight:"4px solid #F97316",borderRadius:"0 12px 0 0"}}/>
          <div style={{position:"absolute",bottom:-2,left:-2,width:40,height:40,borderBottom:"4px solid #F97316",borderLeft:"4px solid #F97316",borderRadius:"0 0 0 12px"}}/>
          <div style={{position:"absolute",bottom:-2,right:-2,width:40,height:40,borderBottom:"4px solid #F97316",borderRight:"4px solid #F97316",borderRadius:"0 0 12px 0"}}/>
          <div style={{width:160,height:2,background:"#F97316",opacity:.5,position:"absolute",animation:"scanLine 2s ease-in-out infinite"}}/>
