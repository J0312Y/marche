...
function ChatScr({onBack,go}){
  ...
  if (isGuest) return (<GuestBlockedView
      icon="chat"
      title="Communiquez avec les vendeurs"
      subtitle="Connectez-vous pour poser vos questions et négocier directement avec les vendeurs."
      benefits={["Messages directs", "Photos et vocaux", "Réponses rapides"]}
      accent="#10B981"
