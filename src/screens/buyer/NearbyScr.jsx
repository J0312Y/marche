...
function NearbyScr({go,onBack}){
  ...
  return(<>
    ...
    >
      ...
      <div style={{position:"absolute",bottom:12,left:12,right:12,zIndex:1000,background:"var(--card)",padding:12,borderRadius:16,boxShadow:"0 4px 20px rgba(0,0,0,.12)",display:"flex",alignItems:"center",gap:12}}>
        <div style={{width:44,height:44,borderRadius:12,overflow:"hidden",background:"linear-gradient(135deg,#F97316,#FB923C)",display:"flex",alignItems:"center",justifyContent:"center",fontSize:22,flexShrink:0}}>
