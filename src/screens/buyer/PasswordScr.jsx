...
function PasswordScr({onBack}){
  ...
  return(<div className="scr" style={{padding:16}}><div className="appbar" style={{padding:0,marginBottom:12}}><button onClick={onBack}>←</button><h2>Mot de passe</h2><div style={{width:38}}/></div>
    <div className="field"><label>Mot de passe actuel <span style={{color:"#EF4444"}}>*</span></label><input type="password" placeholder="••••••••"/></div>
    <div className="field"><label>Nouveau mot de passe <span style={{color:"#EF4444"}}>*</span></label><input type="password" placeholder="Min. 8 caractères"/></div>
    <div className="field"><label>Confirmer <span style={{color:"#EF4444"}}>*</span></label><input type="password" placeholder="Répéter le mot de passe"/></div>
