...
function ReferralScr({ onBack,go}) {
  ...
  if (isGuest) return (<GuestBlockedView
      ...
      subtitle="Connectez-vous pour inviter vos amis et gagner des bons d\'achat à chaque inscription."
      benefits={["5 000 FCFA par parrainage", "Bonus illimités", "Code personnel"]}
      accent="#EF4444"
