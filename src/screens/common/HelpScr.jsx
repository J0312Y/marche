...
function HelpScr({onBack}){
  ...
  const faqs=[
    ...
    {q:"Puis-je annuler une commande ?",a:"Oui, avant l'expédition. Commandes → Détail → Annuler. Vous recevrez un avoir Lamuka utilisable sur votre prochaine commande.",cat:"orders"},
    ...
    {q:"Quels moyens de paiement acceptés ?",a:"• Cash à la livraison (mode actuel)\n\nPréparez le montant exact pour le livreur. D'autres modes de paiement (Airtel Money, MTN MoMo) seront disponibles dans une future version.",cat:"payment"},
    ...
    {q:"Comment obtenir un remboursement ?",a:"Après annulation, le remboursement est effectué :\n• En cash (si la livraison n'a pas eu lieu — vendeur vous contacte)\n• En crédit Lamuka (avoir utilisable sur prochain achat)\nDélai habituel : 24-48h.",cat:"payment"},
