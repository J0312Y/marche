...
function TermsScr({onBack}){
  ...
  return(<div className="scr"><div className="appbar"><button onClick={onBack}>←</button><h2>Conditions générales</h2><div style={{width:38}}/></div>
    <div style={{padding:"0 16px 20px"}}>
      <div style={{padding:14,background:"rgba(249,115,22,0.04)",border:"1px solid rgba(249,115,22,0.1)",borderRadius:14,marginBottom:12}}><div style={{fontSize:12,color:"#F97316",fontWeight:600}}><Icon name="document" size={16}/>{" "}Conditions Générales d'Utilisation</div><div style={{fontSize:11,color:"var(--muted)",marginTop:4}}>Dernière mise à jour : 1er Février 2026</div></div>
