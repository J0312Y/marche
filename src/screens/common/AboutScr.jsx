...
function AboutScr({onBack}){
  return(<div className="scr" style={{padding:16}}><div className="appbar" style={{padding:0,marginBottom:12}}><button onClick={onBack}>←</button><h2>À propos</h2><div style={{width:38}}/></div>
    <div style={{textAlign:"center",marginBottom:24}}><div style={{width:72,height:72,borderRadius:20,background:"linear-gradient(135deg,#6366F1,#A855F7)",display:"flex",alignItems:"center",justifyContent:"center",marginBottom:8}}><svg width="40" height="40" viewBox="0 0 64 64" fill="none"><path d="M16 16h5l6 26h16l6-20H24" stroke="#fff" strokeWidth="3.5" strokeLinecap="round" strokeLinejoin="round"/><circle cx="28" cy="50" r="3.5" fill="#fff"/><circle cx="42" cy="50" r="3.5" fill="#fff"/></svg></div><h2 style={{fontSize:22,fontWeight:700}}>Lamuka Marketplace</h2><p style={{fontSize:13,color:"#908C82"}}>Version 1.0.0</p></div>
