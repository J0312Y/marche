...
function DrWalletScr({go,onBack}){
  ...
  return(<div className="scr"><div className="appbar"><button onClick={onBack}>←</button><h2>Mes gains</h2><div style={{width:38}}/></div>
    ...
    <div className="vw-btns"><button className="vw-withdraw" style={{background:"#F97316"}} onClick={()=>go("drWithdraw")}> Retirer vers MoMo</button><button className="vw-history" onClick={()=>go("drHistory")}><Icon name="chart_pie" size={16}/>{" "}Détails</button></div>
