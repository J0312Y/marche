  ...
  return(<div className="scr"><div className="appbar"><button onClick={onBack}>←</button><h2>Aide & Support</h2><div style={{width:38}}/></div>
    ...
    <div style={{padding:16}}>
      ...
      <div style={{display:"flex",gap:10}}>
        <div style={{flex:1,padding:16,background:"var(--card)",border:"1px solid var(--border)",borderRadius:16,textAlign:"center",cursor:"pointer"}}><div style={{fontSize:24,marginBottom:4}}><Icon name="chat" size={18}/></div><div style={{fontSize:12,fontWeight:600}}>WhatsApp</div><div style={{fontSize:11,color:"var(--muted)"}}>+242 064 663 469</div></div>
        <div style={{flex:1,padding:16,background:"var(--card)",border:"1px solid var(--border)",borderRadius:16,textAlign:"center",cursor:"pointer"}}><div style={{fontSize:24,marginBottom:4}}><Icon name="mail" size={18}/></div><div style={{fontSize:12,fontWeight:600}}>Email</div><div style={{fontSize:11,color:"var(--muted)"}}>joeldytsina94@gmail.com</div></div>
      </div>
    </div>
  </div>);
}
