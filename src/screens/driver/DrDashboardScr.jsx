...
function DrDashboardScr({go}){
  ...
  return(<div className="scr">
    ...
    <div className="dr-active" onClick={()=>go("drDelivery",active)}>
      ...
      <div style={{fontSize:13,color:"var(--sub)",marginBottom:8}}>{active.vendor.name} → {active.client.name}</div>
    ...
    <div style={{padding:"0 16px 80px"}}>{D_HISTORY.slice(0,3).map(h=><div key={h.id} style={{display:"flex",alignItems:"center",gap:12,padding:"12px 0",borderBottom:"1px solid var(--border)"}}>
