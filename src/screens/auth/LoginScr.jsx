...
function LoginScr({onDone,onSocial}){
  ...
  return(
    <div className="auth">
      ...
      <p style={{textAlign:"center",fontSize:12,color:"var(--muted)",marginTop:24}}>En continuant, vous acceptez nos <b style={{color:"#F97316",cursor:"pointer"}} onClick={()=>setLegal("terms")}>Conditions</b> et <b style={{color:"#F97316",cursor:"pointer"}} onClick={()=>setLegal("privacy")}>Politique de confidentialité</b></p>
    </div>
  );
}
