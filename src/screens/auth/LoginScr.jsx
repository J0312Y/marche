...
function LoginScr({onDone,onSocial}){
  ...
  return(
    <div className="auth">
      ...
      <button className="btn-primary" onClick={()=>{const digits=phone.replace(/\s/g,"");if(digits.length!==9){setPhoneErr("Le numéro doit contenir 9 chiffres après +242");return}setPhoneErr("");onDone()}}>{t("auth.continue")}</button>
