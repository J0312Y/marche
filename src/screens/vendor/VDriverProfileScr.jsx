...
function VDriverProfileScr({driver:d,go,onBack}){
  ...
  return(<div className="scr" style={{paddingBottom:20}}>
    ...
    <div style={{display:"flex",gap:10,padding:"0 16px",marginBottom:12}}>
      <button style={{flex:1,padding:12,borderRadius:14,border:"none",background:"#10B981",color:"#fff",fontSize:13,fontWeight:600,cursor:"pointer",fontFamily:"inherit",display:"flex",alignItems:"center",justifyContent:"center",gap:6}} onClick={()=>toast.info("📞 Appel vers "+d.name)}>📞 Appeler</button>
