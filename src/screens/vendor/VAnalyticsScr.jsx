...
function VAnalyticsScr({onBack}){
  ...
  return(<div className="scr" style={{padding:16,paddingBottom:20}}>
    <div className="appbar" style={{padding:0,marginBottom:12}}><button onClick={onBack}>←</button><h2><Icon name="chart_pie" size={16}/>{" "}Analytics</h2><div style={{width:38}}/></div>
    ...
    <div style={{padding:14,background:"var(--card)",border:"1px solid var(--border)",borderRadius:16,marginBottom:14}}>
      <div style={{fontSize:14,fontWeight:700,marginBottom:10}}><Icon name="crown" size={16}/>{" "}Produits les + performants</div>
      {topProducts.map((p,i)=>(
    ...
    <div style={{padding:14,background:"var(--card)",border:"1px solid var(--border)",borderRadius:16}}>
      <div style={{fontSize:14,fontWeight:700,marginBottom:10}}><Icon name="location" size={16}/>{" "}Sources de trafic</div>
      {sources.map((s,i)=>(
