...
function VAddDriverScr({onBack}){
  ...
  return(<><div className="appbar"><button onClick={onBack}>←</button><h2>Ajouter un livreur</h2><div style={{width:38}}/></div>
    <div className="scr" style={{padding:16}}>
      ...
      <div className="field"><label>Nom complet <span style={{color:"#EF4444"}}>*</span></label><input placeholder="Ex: Patrick Moukala"/></div>
      <div className="field"><label>Téléphone <span style={{color:"#EF4444"}}>*</span></label><input placeholder="+242 06X XXX XXX" type="tel"/></div>
