...
function VUpgradePlanScr({onBack,onUpgrade,currentPlan="starter"}){
  ...
  return(<><div className="appbar"><button onClick={onBack}>←</button><h2>Changer de plan</h2><div style={{width:38}}/></div>
    <div className="scr" style={{padding:20}}>
      <div style={{textAlign:"center",marginBottom:20}}><div style={{fontSize:48,marginBottom:8}}>⬆️</div><h3 style={{fontSize:18,fontWeight:700}}>Boostez votre commerce</h3><p style={{fontSize:13,color:"#908C82"}}>Choisissez le plan qui correspond à vos ambitions</p></div>
