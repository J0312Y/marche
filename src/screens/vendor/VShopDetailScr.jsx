  ...
  return(<div className="scr">
    ...
    {isActive&&<>
      ...
      {tab===1&&<div style={{padding:"0 16px 20px"}}>
        ...
        <div className="bottom-action-bar"><button className="btn-primary" style={{background:saved?"#10B981":"#F97316"}} onClick={doSave}>{saved?"Modifications enregistrées":"Enregistrer les modifications"}</button></div>
      </div>}
