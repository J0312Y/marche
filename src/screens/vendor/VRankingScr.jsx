...
const RANKINGS=[
  ...
  {rank:3,name:"Chez Mama Ngudi",avatar:"",score:8100,orders:456,rating:4.9,badge:""},
...
function VRankingScr({onBack}){
  ...
  return(<div className="scr" style={{padding:16,paddingBottom:20}}>
    <div className="appbar" style={{padding:0,marginBottom:12}}><button onClick={onBack}>←</button><h2><Icon name="crown" size={16}/>{" "}Classement</h2><div style={{width:38}}/></div>
