...
function VApiScr({go,onBack}){
  ...
  return(<div className="scr" style={{padding:16}}>
    ...
    <div className="info-box blue" style={{marginTop:10}}><span><Icon name="phone" size={18}/></span><span style={{fontSize:11}}>Manager dédié : <b>support-enterprise@lamuka.cg</b> · +242 06X XXX XXX</span></div>
  </div>);
}
