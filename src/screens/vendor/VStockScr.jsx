...
const STOCK = [
  {id:1,name:"Galaxy A54",img:"phone",stock:15,min:5,status:"ok",lastRestock:"12 Mar"},
  {id:2,name:"Robe Wax Moderne",img:"package",stock:8,min:5,status:"ok",lastRestock:"10 Mar"},
  {id:3,name:"Écouteurs Bluetooth",img:"",stock:3,min:5,status:"low",lastRestock:"8 Mar"},
  {id:4,name:"Doliprane 1000mg",img:"pill",stock:2,min:10,status:"critical",lastRestock:"5 Mar"},
  {id:5,name:"Riz Parfumé 25kg",img:"utensils",stock:0,min:3,status:"out",lastRestock:"1 Mar"},
...
function VStockScr({onBack}){
  ...
  return(<div className="scr" style={{padding:16,paddingBottom:20}}>
    <div className="appbar" style={{padding:0,marginBottom:12}}><button onClick={onBack}>←</button><h2><Icon name="package" size={16}/>{" "}Gestion Stock</h2><div style={{width:38}}/></div>
