    ...
    <div style={{ position: "relative", padding: "14px 28px 8px", flexShrink: 0, background: "transparent", zIndex: 20 }}>
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 6, width: 72, justifyContent: "flex-end" }}>
          <svg width="18" height="12" viewBox="0 0 18 12" fill="none"><rect x="0" y="8" width="3" height="4" rx="1" fill="var(--text)"/><rect x="4.5" y="5.5" width="3" height="6.5" rx="1" fill="var(--text)"/><rect x="9" y="3" width="3" height="9" rx="1" fill="var(--text)"/><rect x="13.5" y="0" width="3" height="12" rx="1" fill="var(--text)"/></svg>
          <svg width="16" height="12" viewBox="0 0 16 12" fill="none"><path d="M8 2.5c-2.7 0-5.15 1.1-6.93 2.87l1.42 1.42A7.65 7.65 0 018 4.5c2.12 0 4.05.86 5.51 2.29l1.42-1.42A9.69 9.69 0 008 2.5z" fill="var(--text)" opacity=".95"/><path d="M8 6c-1.66 0-3.17.67-4.24 1.76l1.41 1.41A3.98 3.98 0 018 8c1.1 0 2.1.45 2.83 1.17l1.41-1.41A5.97 5.97 0 008 6z" fill="var(--text)" opacity=".95"/><circle cx="8" cy="11" r="1.2" fill="var(--text)"/></svg>
          <svg width="28" height="13" viewBox="0 0 28 13" fill="none"><rect x="0.5" y="0.5" width="23" height="12" rx="3.5" stroke="currentColor" strokeWidth="1" opacity=".35"/><rect x="2" y="2" width="19.5" height="9" rx="2.5" fill="var(--text)"/><path d="M25 4.5c.8.4 1.3 1.1 1.3 2s-.5 1.6-1.3 2V4.5z" fill="var(--text)" opacity=".4"/></svg>
        </div>
      </div>
