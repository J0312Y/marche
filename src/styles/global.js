...
.btn-primary{width:100%;padding:12px;border-radius:12px;border:none;background:#6366F1;color:#fff;font-size:15px;font-weight:600;cursor:pointer;font-family:inherit;transition:opacity .15s}.btn-primary:hover{opacity:.85}
...
.field{margin-bottom:10px}.field label{display:block;font-size:12px;font-weight:600;color:var(--sub);margin-bottom:5px}.field input,.field textarea,.field select{width:100%;padding:12px 14px;border-radius:12px;border:1px solid var(--border);background:var(--light);color:var(--text);font-family:inherit;font-size:14px;outline:none;color:var(--text);resize:none}.field input:focus,.field textarea:focus{border-color:#6366F1}
...
.onb-dot{width:8px;height:8px;border-radius:50%;background:var(--border);transition:all .3s}.onb-dot.on{width:24px;border-radius:4px;background:#6366F1}
...
.otp-box:focus{border-color:#6366F1;background:var(--card)}
...
.banner-btn{display:inline-block;padding:10px 20px;background:var(--card);border-radius:12px;font-size:12px;font-weight:700;color:#6366F1;cursor:pointer}
...
.cat-card:hover{border-color:#6366F1}.cat-card .cci{font-size:28px;flex-shrink:0}.cat-card h4{font-size:13px;font-weight:600;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.cat-card p{font-size:10px;color:var(--muted);white-space:nowrap}
...
.pbody .pp{font-size:14px;font-weight:700;color:#6366F1;display:flex;align-items:center;gap:6px}
...
.det-price{display:flex;align-items:end;gap:10px;margin-bottom:18px}.det-price .dp{font-size:24px;font-weight:700;color:#6366F1}.det-price .dpo{font-size:14px;color:var(--muted);text-decoration:line-through}
...
.cs-row.tot{color:var(--text);font-size:16px;font-weight:700;margin-top:10px;padding-top:10px;border-top:1px solid var(--border)}.cs-row.tot .ctp{color:#6366F1}
...
.sline{width:28px;height:2px;background:var(--border)}.sline.on{background:#6366F1}
.step-col{display:flex;flex-direction:column;align-items:center}.slbl{font-size:9px;color:var(--muted);text-align:center;margin-top:4px}.slbl.on{color:#6366F1}
...
.confirm-card .cci{font-size:20px;color:#6366F1}.confirm-card .ccb{flex:1}.confirm-card .ccb small{font-size:11px;color:var(--muted)}.confirm-card .ccb p{font-size:14px;font-weight:600;margin:0}.confirm-card .cce{font-size:11px;color:#6366F1;font-weight:600;cursor:pointer}
...
.success-box h2{font-size:22px;font-weight:700;margin-bottom:6px}.success-box p{font-size:14px;color:var(--sub);margin-bottom:4px}.success-box .ref{font-size:13px;color:#6366F1;font-weight:600;margin-bottom:20px}
...
.map-driver{position:absolute;top:calc(45% - 20px);left:32%;font-size:22px;background:var(--card);border-radius:50%;width:38px;height:38px;display:flex;align-items:center;justify-content:center;box-shadow:0 4px 16px rgba(99,102,241,.3);border:3px solid #6366F1;animation:dmove 3s ease-in-out infinite alternate}
...
.eta-bar{height:6px;background:var(--border);border-radius:3px;overflow:hidden;margin-bottom:8px}.eta-fill{height:100%;background:linear-gradient(90deg,#6366F1,#A855F7);border-radius:3px}
...
.chat-input input{flex:1;padding:12px 16px;border-radius:24px;border:1px solid var(--border);background:var(--light);color:var(--text);font-size:13px;font-family:inherit;outline:none;color:var(--text)}.chat-input input:focus{border-color:#6366F1}
...
.vr-line{width:16px;height:2px;background:var(--border)}.vr-line.on{background:#6366F1}
.vr-lbl{font-size:7px;color:var(--muted);text-align:center;margin-top:3px;white-space:nowrap}.vr-lbl.on{color:#6366F1}
...
.vr-upload{padding:32px;border:2px dashed var(--border);border-radius:18px;text-align:center;cursor:pointer;background:var(--light);margin-bottom:14px}.vr-upload:hover{border-color:#6366F1}
.vr-upload .vu-icon{font-size:36px;margin-bottom:8px}.vr-upload p{font-size:13px;color:var(--muted)}.vr-upload b{font-size:14px;color:#6366F1}
...
.vr-plan{padding:16px;border-radius:16px;border:2px solid var(--border);margin-bottom:10px;cursor:pointer;background:var(--card)}.vr-plan.on{border-color:#6366F1;background:rgba(99,102,241,0.03)}
...
.vr-doc{display:flex;align-items:center;gap:12px;padding:14px;border-radius:14px;border:1px solid var(--border);margin-bottom:8px;cursor:pointer;background:var(--card)}.vr-doc:hover{border-color:#6366F1}
...
.coupon-right .cc{display:inline-block;margin-top:8px;padding:4px 12px;border-radius:6px;background:var(--light);font-size:12px;font-weight:700;color:#6366F1;letter-spacing:.5px;cursor:pointer}
...
.prof-stats .ps{flex:1;text-align:center}.prof-stats .ps b{display:block;font-size:18px;color:#6366F1}.prof-stats .ps span{font-size:11px;color:var(--muted)}
...
.vp-btns .vb1{border:none;background:#6366F1;color:#fff}.vp-btns .vb2{border:1px solid var(--border);background:var(--card);color:var(--text)}
...
/* Wallet */
.vw-card{margin:0 16px 12px;padding:18px;border-radius:18px;color:#fff;background:linear-gradient(135deg,#6366F1,#8B5CF6,#A855F7);color:#fff;text-align:center;position:relative;overflow:hidden}
...
.dr-accept{background:#10B981;color:#fff}.dr-decline{background:var(--light);color:var(--sub)}
...
.dr-step-line{flex:1;height:3px;background:var(--border);min-width:8px}.dr-step-line.done{background:#10B981}
