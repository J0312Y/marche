...
const D_DELIVERIES=[
  {id:"dl1",ref:"#CMD-0891",vendor:{name:"Mode Afrique",avatar:"🛍️",phone:"+242 06X XXX",logo:LOGOS["Mode Afrique"]},client:{name:"Marie Koumba",phone:"+242 06X XXX",addr:"Quartier Bacongo, Rue 14, N°42",lat:-4.277,lng:15.283},items:[{name:"Robe Wax Moderne",qty:2,img:"🛍️",photo:PHOTOS["Robe Wax Moderne"]},{name:"Sac à Main Cuir",qty:1,img:"🛍️",photo:PHOTOS["Sac à Main Cuir"]}],total:92000,pickup:"Marché Total, Stand 42",status:"active",distance:"3.2 km",eta:"12 min",fee:2500,tip:500},
  {id:"dl3",ref:"#CMD-0887",vendor:{name:"Chez Mama Ngudi",avatar:"🍽️",phone:"+242 064 663 469"},client:{name:"Bruno Tsaty",phone:"+242 064 663 469",addr:"Talangaï, Av. Marien Ngouabi",lat:-4.260,lng:15.295},items:[{name:"Poulet DG",qty:2,img:"🍽️",sides:[{name:"Coca-Cola 33cl",qty:2,price:500,img:"🧁"},{name:"Frites",qty:1,price:800,img:"🍽️"},{name:"Piment fort",qty:1,price:0,img:"✨"}]}],total:12800,pickup:"Marché Ouenzé",status:"pending",distance:"2.1 km",eta:"8 min",fee:2000,tip:0,payment:"cash",note:"Bien cuit, sans oignon"},
  {id:"dl4",ref:"#GRP-4521",vendor:{name:"Chez Mama Ngudi",avatar:"🍽️",phone:"+242 064 663 469"},client:{name:"Joeldy Tsina + 2",phone:"+242 064 663 469",addr:"Bacongo, Rue 14",lat:-4.277,lng:15.283},isGroup:true,groupMembers:["Joeldy Tsina","Marie K.","Patrick M."],items:[{name:"Poulet DG",qty:2,img:"🍽️",photo:"https://images.unsplash.com/photo-1598515214211-89d3c73ae83b?w=400&h=400&fit=crop"},{name:"Poisson Braisé",qty:1,img:"🍽️",photo:"https://images.unsplash.com/photo-1580476262798-bddd9f4b7369?w=400&h=400&fit=crop"},{name:"Gâteau Forêt Noire",qty:2,img:"🧁",photo:"https://images.unsplash.com/photo-1578985545062-69928b1d9587?w=400&h=400&fit=crop"}],total:39000,pickup:"Chez Mama Ngudi, Ouenzé",status:"pending",distance:"3.5 km",eta:"15 min",fee:3000,tip:0,note:"️ Commande de groupe (3 personnes) — livrer ensemble"},
  {id:"dl2",ref:"#CMD-0890",vendor:{name:"Tech Congo",avatar:"🏪",phone:"+242 06X XXX",logo:LOGOS["Tech Congo"]},client:{name:"Patrick Mbemba",phone:"+242 06X XXX",addr:"Poto-Poto, Avenue de la Paix, N°8",lat:-4.269,lng:15.289},items:[{name:"Chemise Bogolan",qty:1,img:"🛍️",photo:PHOTOS["Chemise Bogolan"]}],total:18000,pickup:"Marché Total, Stand 15",status:"pending",distance:"4.8 km",eta:"20 min",fee:2500,tip:0},
];
const D_HISTORY=[
