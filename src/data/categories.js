const CATS = [
  // Fashion
  { id:"1", name:"Mode Femme", icon:"👗", count:124, type:"boutique", photo:"https://images.unsplash.com/photo-1483985988355-763728e1935b?w=200&h=200&fit=crop",
    subs:[
  ...
  { id:"2", name:"Mode Homme", icon:"👔", count:78, type:"boutique", photo:"https://images.unsplash.com/photo-1490578474895-699cd4e2cf59?w=200&h=200&fit=crop",
    subs:[
  ...
  { id:"3", name:"Chaussures Femme", icon:"👠", count:45, type:"boutique", photo:"https://images.unsplash.com/photo-1543163521-1bf539c55dd2?w=200&h=200&fit=crop",
    subs:[
  ...
  { id:"4", name:"Chaussures Homme", icon:"👞", count:38, type:"boutique", photo:"https://images.unsplash.com/photo-1614252369475-531eba835eb1?w=200&h=200&fit=crop",
    subs:[
  ...
  { id:"5", name:"Sacs & Bagages", icon:"👜", count:62, type:"boutique", photo:"https://images.unsplash.com/photo-1548036328-c9fa89d128fa?w=200&h=200&fit=crop",
    subs:[
  ...
  // Beauty
  { id:"7", name:"Beauté", icon:"💄", count:89, type:"boutique", photo:"https://images.unsplash.com/photo-1596462502278-27bfdc403348?w=200&h=200&fit=crop",
    subs:[
  ...
  // Bébé & Enfant
  { id:"16", name:"Bébé & Enfant", icon:"🍼", count:92, type:"boutique", photo:"https://images.unsplash.com/photo-1515488764276-beab7607c1e6?w=200&h=200&fit=crop",
    subs:[
  ...
  // Sport
  { id:"18", name:"Sport & Loisirs", icon:"⚽", count:58, type:"boutique", photo:"https://images.unsplash.com/photo-1517649763962-0c623066013b?w=200&h=200&fit=crop",
    subs:[
  ...
  // Hygiene
  { id:"19", name:"Hygiène & Entretien", icon:"🧴", count:48, type:"boutique", photo:"https://images.unsplash.com/photo-1556909114-f6e7ad7d3136?w=200&h=200&fit=crop",
    subs:[
