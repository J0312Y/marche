...
const NOTIFS = [
  ...
  // DELIVERY UPDATE
  { id:"n7", icon:"📦", title:"Commande livrée", body:"#LMK-2026-0213 — Notez votre expérience pour gagner 50 points", time:"il y a 2 jours", type:"delivery", action:"orders", unread:false },
