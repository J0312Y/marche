...
const V_ORDERS=[
  ...
  {id:"vo6",ref:"#GRP-4521",client:"Joeldy Tsina + 2",phone:"+242 064 663 469",addr:"Bacongo, Rue 14",isGroup:true,groupMembers:[{name:"Joeldy Tsina",items:[{name:"Poulet DG",qty:1,price:5500,img:"🍗"}]},{name:"Marie K.",items:[{name:"Poulet DG",qty:1,price:5500,img:"🍗"},{name:"Poisson Braisé",qty:1,price:4000,img:"🐟"}]},{name:"Patrick M.",items:[{name:"Gâteau Forêt Noire",qty:2,price:12000,img:"🎂"}]}],items:[{name:"Poulet DG",qty:2,price:5500,img:"🍗"},{name:"Poisson Braisé",qty:1,price:4000,img:"🐟"},{name:"Gâteau Forêt Noire",qty:2,price:12000,img:"🎂"}],total:39000,status:"new",date:"15 Fév 12:15",payment:"Airtel Money",note:"Commande de groupe — livrer ensemble"},
